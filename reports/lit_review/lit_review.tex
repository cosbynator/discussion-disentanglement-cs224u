...
\label{sec:threaded}
We define \textit{forum-style disentanglement} as creating 
graphical parent-child links between posts under a related topic. The primary characteristic of the problem 
...
Finally, thread detection is done by clustering. The algorithm iterates 
