...
running the unsupervised speech act model of~\newcite{Paula} but found the
...
\begin{table}[ht]\footnotesize
 \begin{tabular}{| l | l | l | l | l | l | l |} 
   \hline
   \textbf{Feature} & \multirow{2}{*}{\shortstack{Tree\\*F1}} 
   & \multirow{2}{*}{\shortstack{Avg.\\*F1}} 
   & \multicolumn{4}{c|}{$B^3$ depth} \\
                      & & & 1 & 2 & 3 & 4\\
   \hline
   ...
   % This indicates that TF-IDF is mostly helpful in sub-discussions, which is
   % interesting
       Author Mention & 0.46 & 0.48 & 0.64 & 0.07 & 0.07 & \\
   % This indicates author mentions are really only useful at top level, which
   % is interesting
        Reply to Self & 0.48 & 0.50 & 0.63 & 0.21 & & \\
   % Indicates people reply to themselves at the top level rarely, but
   % sometimes lower in the tree
Named Entities & 0.44 & 0.46 & 0.64 & 0.12 & 0.12 & 0.16 \\
   % Kind of contrasts to the TF-IDF feature, people only talk about similar
   % entities high in the tree?
   ...
   % Pretty much a "for funzies" feature. Interesting that it predicts more in
   % sub-discussions
   ...
   \hline
  \end{tabular}
  \caption{Development Set Scores on AskHN data for Naïve Bayes run exclusively
  on a single feature}
...
\begin{table}[h]\footnotesize
 \begin{tabular}{| c | l | l | l | l | l | c |} 
   \hline
   \textbf{Test} & \multirow{2}{*}{\shortstack{Tree\\F1}} 
   & \multirow{2}{*}{\shortstack{Avg.\\F1}} 
   & \multicolumn{4}{c|}{$B^3$ depth} \\
                      & & & 1 & 2 & 3 & 4\\
   \hline
  ...
  \multirow{2}{*}{\shortstack{Our Model \\ {\em(F1 Optimized)}}} & \textbf{0.49} & \textbf{0.51} & \textbf{0.65} & 0.06 &
                0.09 & 0.11 \\
                                                                      & & & & & & \\
   \multirow{2}{*}{\shortstack{Our Model \\ {\em($B^3$ Optimized)}}} & 0.34 & 0.36 & 0.44 & \textbf{0.50} &
